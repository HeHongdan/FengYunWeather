...
class AppRepo {
    ...
    private val cacheDao: CacheDao = AppDatabase.getInstance(MyApplication.getContext()).cacheDao()

    private val cityDao: CityDao = AppDatabase.getInstance(MyApplication.getContext()).cityDao()
